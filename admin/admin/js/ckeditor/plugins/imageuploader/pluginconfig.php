...
$_COOKIE["show_news"] = "no";

$foldershistory = array();
$useruploadroot = "http://$_SERVER[HTTP_HOST]";
$browserfolder = pathinfo("$_SERVER[REQUEST_URI]");
$browserfolder = dirname($browserfolder["dirname"]);
$useruploadpath = $browserfolder;
for($i=4; $i>0; $i--)
  $useruploadpath=dirname($useruploadpath);
$useruploadpath.="/site/images/posts/";
$useruploadpath=$useruploadroot."$useruploadpath";
/* useruploadpath - como eh visto do lado de fora */
...
$useruploadfolder='../../../../../site/images/posts/';
//$useruploadfolder=realpath($useruploadfolder);


//echo "<div>$useruploadfolder</div>";
//die(phpinfo());
