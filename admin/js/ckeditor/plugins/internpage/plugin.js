...
(function() {
	...
	// CKEDITOR.scriptLoader.load(CKEDITOR.plugins.getPath('internpage') + 'pages.php?type=js');
	...
	// 			'default': '',
	// 			style: 'width:100%',
	// 			items: d.config.InternPagesSelectBox,
	// 			onChange: function() {
...
// 			var baseUrl = CKEDITOR.plugins.getPath('internpage');
